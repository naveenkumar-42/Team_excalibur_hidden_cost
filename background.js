...
chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
  if (request.action === 'turnOnHighlighting') {
    isHighlighting = true; // Turn on highlighting
  } else if (request.action === 'turnOffHighlighting') {
    isHighlighting = false; // Turn off highlighting
  }
